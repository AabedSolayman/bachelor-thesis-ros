...
class RangesImageConverter:
    ...
    def __init__(self,laser_position, room_coordinates, ranges_arr_length):
        ...
        rospy.Subscriber("/lidar_bottom/scan", LaserScan, self.ranges_callback)
    ...
    def update_image(self,ranges_arr):    
        ...
        x_pixels = (x*10).astype(int) + self.laser_position[0]+self.room_coordinates[0]
        y_pixels = (y*10).astype(int) + self.laser_position[1]+self.room_coordinates[1]
